...
namespace System.Web.Services.Protocols {
    ...
    public class WebServiceHandlerFactory {//: IHttpHandlerFactory {
        ...
        */
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        public IHttpHandler GetHandler(HttpContext context, Type serviceType) {//string verb, string url, string filePath) { 
...
//#endif
            ...
            IHttpHandler handler = CoreGetHandler(serviceType, context, context.Request, context.Response);
        ...
        internal IHttpHandler CoreGetHandler(Type type, HttpContext context, HttpRequest request, HttpResponse response) {
            ...
            if(protocol.MethodInfo.IsTaskAsync)
            {
                return new TaskSessionlessHandler(protocol);
            }
