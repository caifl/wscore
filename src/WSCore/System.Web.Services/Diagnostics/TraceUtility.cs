...
namespace System.Web.Services.Diagnostics {
    ...
    internal static class Tracing {
        ...
        private const string TraceSourceAsmx = "WSCore.Asmx";
            ...
            lock (InternalSyncObject) {
                if (!tracingInitialized) {
                  bool loggingEnabled = false;
                    ...
                    //switch
                    var switchItem = new SourceSwitch("Console", "Information")
                    {
                        Level = SourceLevels.All
                    };

                    asmxTraceSource.Switch = switchItem;
                    asmxTraceSource.Listeners.Add(new ConsoleTraceListener());

                    //var section = System.Configuration.ConfigurationManager.GetSection("system.diagnostics");
                    //if(section != null && section is SystemDiagnosticsSection)
                    //{
                    //    var sds = section as SystemDiagnosticsSection;
                    //    sds.Apply(asmxTraceSource);
                    //}
