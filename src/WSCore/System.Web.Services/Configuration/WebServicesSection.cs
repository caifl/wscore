...
namespace System.Web.Services.Configuration {
    ...
    public sealed class WebServicesSection : ConfigurationSection {
        ...
        private static WebServicesSection instance;
        ...
        public static WebServicesSection Current {
            get {
                ...
                if (instance == null) {
                    var section = new WebServicesSection();
                    section.InitializeDefault();

                    //section.SoapExtensionImporterTypes.Add(new TypeElement(ty))

                    //var items = section.Protocols;

                    //items.Add(new ProtocolElement(WebServiceProtocols.HttpSoap));
                    //items.Add(new ProtocolElement(WebServiceProtocols.HttpSoap12));
                    ////items.Add(new ProtocolElement(WebServiceProtocols.AnyHttpSoap));
                    //items.Add(new ProtocolElement(WebServiceProtocols.Documentation));

                    instance = section;//(WebServicesSection)PrivilegedConfigurationManager.GetSection(WebServicesSection.SectionName);
                    //instance = retval;
                }
        ...
        internal Type[] DiscoveryReferenceTypes {
            get { throw new NotImplementedException(); }//return this.discoveryReferenceTypes; }
        }
        ...
        static public WebServicesSection GetSection(Configuration config) {
            ...
            return WebServicesSection.Current;
        ...
        internal Type[] MimeImporterTypes {
            get { throw new NotImplementedException(); } //return this.mimeImporterTypes; }
        }
